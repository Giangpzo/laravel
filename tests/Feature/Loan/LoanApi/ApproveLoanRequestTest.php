...
class ApproveLoanRequestTest extends LoanTestCase
{
    use RefreshDatabase;
    ...
    {
        return $this->url . '/' . $loan->id . '/approve';
    }
    ...
    public function test_customer_cannot_approve_another_one_loan_request(): void
    {
        $loan = $this->createLoan();
        $url = $this->calculateActualUrl($loan);
    ...
    public function test_customer_cannot_approve_his_loan_request(): void
    {
        $loan = $this->createLoan();
        $url = $this->calculateActualUrl($loan);
        $notes = Helpers::generate_string_by_length(255);
    ...
    public function test_admin_cannot_approve_approved_loan_request(): void
    {
    ...
    public function test_admin_cannot_approve_rejected_loan_request(): void
    {
    ...
    public function test_admin_cannot_approve_paid_loan_request(): void
    {
    ...
    public function test_admin_approve_pending_loan_request(): void
    {
        $loan = $this->createLoan();
        $url = $this->calculateActualUrl($loan);
        $notes = Helpers::generate_string_by_length(255);
